...
*/
    ...
    public void testApiFetchDataSuccess() {
        ...
        viewModel.fetchNews();
        verify(observer).onChanged(refEq(NewsListViewState.LOADING_STATE));
        verify(observer).onChanged(refEq(NewsListViewState.SUCCESS_STATE));
    }
